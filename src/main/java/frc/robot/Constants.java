...
public final class Constants {
    ...
    public static final class Swerve {
        ...
        public static final class Mod0 { //done
            ...
            public static final Rotation2d angleOffset = Rotation2d.fromDegrees(-113.0);//-113 //67  tamalandı
        ...
        public static final class Mod1 { //done
            ...
            public static final Rotation2d angleOffset = Rotation2d.fromDegrees(75.4+90); //132.75 //-47.25 tamamlandı
            public static final SwerveModuleConstants constants = 
                new SwerveModuleConstants(driveMotorID, angleMotorID, canCoderID, angleOffset);
        }
        ...
        public static final class Mod2 { //done
            ...
            public static final Rotation2d angleOffset = Rotation2d.fromDegrees(-84.8);//-39.25 //140.75
            public static final SwerveModuleConstants constants = 
                new SwerveModuleConstants(driveMotorID, angleMotorID, canCoderID, angleOffset);
        }
        ...
        public static final class Mod3 { //done
            ...
            public static final Rotation2d angleOffset = Rotation2d.fromDegrees(76.8+90-180);//154.75 //-25.25
            public static final SwerveModuleConstants constants = 
                new SwerveModuleConstants(driveMotorID, angleMotorID, canCoderID, angleOffset);
        }
